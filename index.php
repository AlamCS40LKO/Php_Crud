...
$update=false;
$delete=false;
$conn=mysqli_connect("localhost:3306","root","","note");
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/php projects/CRUD/index.php" method="POST">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-flusid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <a class="navbar-brand" href="/php projects/CRUD/index.php"><img src ="php_logo.png" alt="logo" height="39px"></a>
   
      <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="/php projects/CRUD/index.php">Home</a>
        </li>
...
?>
 ...
 <div class="container my-3 p-4 w-10" style="border: 2px solid black; border-radius: 20px; width: 50%">
 ...
 <div class="container" mx-1>
  ...
  <?php
    ...
    $sno=0;
      ...
      <td>".$row['dstamp']. "</td>
      <td> <button class='edit btn btn-sm btn-light' id =".$row['Sno'].
      ">Edit</button> 
      <button class='delete btn btn-sm btn-light' id =d".$row['Sno'].
      ">Delete</button></td>
...
<script>
      ...
      Array.from(deletes).forEach((element) => {
        ...
        if(confirm("Are you Sure you want to delete this Note!!")){
          console.log("yes");
          window.location=`/php projects/CRUD/index.php?delete=${sno}`;
